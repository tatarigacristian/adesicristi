      ...
      <div className="card-inner" style={{ flexDirection: "column", justifyContent: "center", alignItems: "center", padding: "0.3cm 0.8cm", gap: 0 }}>
        ...
        <div style={{ display: "flex", flexDirection: "row", alignItems: "center", justifyContent: "center", width: "100%", flex: 1, gap: "0.5cm" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", flex: 1 }}>
            ...
            <p className="card-label" style={{ fontSize: "0.38rem", marginTop: "0.08cm" }}>Scanați codul</p>
          </div>
        </div>
...
export function buildCardStyles(s: CardWeddingSettings | null): string {
  ...
  return `
    ...
    .card-page-root .card-face::before { content: ''; position: absolute; top: 9px; bottom: 9px; left: 0; right: 0; border-top: 1px dashed ${button}4D; border-bottom: 1px dashed ${button}4D; pointer-events: none; }
    .card-page-root .card-face::after { content: ''; position: absolute; top: 0; bottom: 0; left: 9px; right: 9px; border-left: 1px dashed ${button}4D; border-right: 1px dashed ${button}4D; pointer-events: none; }
    .card-page-root .card-outer { width: 100%; height: 100%; box-sizing: border-box; background: ${bgCard}; border: 0.8px solid ${button}80; box-shadow: 0 4px 24px rgba(0,0,0,0.06); position: relative; z-index: 1; }
    .card-page-root .card-inner { display: flex; flex-direction: column; align-items: center; justify-content: center; padding: 0.5cm 0.7cm; position: relative; border: 0.5px solid ${button}4D; margin: 4px; width: calc(100% - 8px); height: calc(100% - 8px); box-sizing: border-box; border-radius: 2px; }
    .card-page-root .corner-ornament { position: absolute; width: 22px; height: 22px; opacity: 0.3; }
    ...
    .card-page-root .card-label { font-family: var(--font-montserrat), 'Montserrat', sans-serif; font-size: 0.35rem; letter-spacing: 0.3em; text-transform: uppercase; color: ${button}; font-weight: 500; margin-bottom: 0.08cm; }
