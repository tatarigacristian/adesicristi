...
function InvitatieV2Content() {
  ...
  const handleShare = useCallback(async (target: "whatsapp" | "messenger") => {
    if (!guest) return;
    const fileName = `invitatie-v2-${guest.prenume}-${guest.nume}.png`;
    ...
    <div className="inv-root" style={{ fontFamily: "'Montserrat', sans-serif" }}>
      ...
      <div className="inv-page">
        <div className="inv-actions">
          ...
          <button className="inv-btn inv-btn-secondary" onClick={() => handleShare("whatsapp")} style={{ display: "flex", alignItems: "center", gap: 6 }}>
          ...
          <button className="inv-btn inv-btn-secondary" onClick={() => handleShare("messenger")} style={{ display: "flex", alignItems: "center", gap: 6 }}>
        ...
        >
          ...
          >
            ...
            {/* 5. "la celebrarea căsătoriei noastre" — replacing personalized text */}
