...
import { SquaresFour, UsersThree, CheckCircle, GridFour, Wallet, Package, Gear, List, ArrowClockwise, SignOut, Printer, Envelope, QrCode, ListChecks } from "@phosphor-icons/react";
...
const NAV_ITEMS: { href: string; label: string; icon: React.ReactNode }[] = [
  ...
  { href: "/admin/program", label: "Program", icon: <ListChecks size={18} weight="duotone" /> },
